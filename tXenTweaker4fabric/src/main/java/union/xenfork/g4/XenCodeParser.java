...
public class XenCodeParser extends Parser {
	...
	public static final int
		...
		T__24=25, T__25=26, T__26=27, T__27=28, LINE_COMMENT=29, COMMENT=30, CLASSNAME=31, 
	...
	public static final int
		...
		RULE_while = 24, RULE_for = 25, RULE_print = 26, RULE_fieldA = 27, RULE_fa = 28;
	private static String[] makeRuleNames() {
		return new String[] {
			"all", "sy", "jh", "field", "s", "i", "f", "d", "l", "b", "str", "int", 
			"float", "double", "long", "boolean", "strings", "ints", "floats", "doubles", 
			"longs", "booleans", "import_", "priority", "while", "for", "print", 
			"fieldA", "fa"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, "LINE_COMMENT", "COMMENT", "CLASSNAME", 
	...
	public final AllContext all() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( ((_la) & ~0x3f) == 0 && ((1L << _la) & 2533236722L) != 0 );
			}
		}
				...
				do {
					...
					case 1:
						...
						case STRING:
							...
							setState(752);
							_la = _input.LA(1);
							if ( !(((_la) & ~0x3f) == 0 && ((1L << _la) & 777389080576L) != 0) ) {
	...
	public final FieldAContext fieldA() throws RecognitionException {
		...
		enterRule(_localctx, 54, RULE_fieldA);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
			...
			case 2:
				...
				setState(768);
				_la = _input.LA(1);
				if ( !(((_la) & ~0x3f) == 0 && ((1L << _la) & 1086626725888L) != 0) ) {
				_errHandler.recoverInline(this);
				}
				else {
					if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public static class FaContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof XenCodeListener ) ((XenCodeListener)listener).enterFa(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof XenCodeListener ) ((XenCodeListener)listener).exitFa(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof XenCodeVisitor) return ((XenCodeVisitor<? extends T>)visitor).visitFa(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final FaContext fa() throws RecognitionException {
		...
		enterRule(_localctx, 56, RULE_fa);
		int _la;
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
