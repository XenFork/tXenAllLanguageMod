...
public interface XenCodeListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link XenCodeParser#allField}.
	 * @param ctx the parse tree
	 */
	void enterAllField(XenCodeParser.AllFieldContext ctx);
	/**
	 * Exit a parse tree produced by {@link XenCodeParser#allField}.
	 * @param ctx the parse tree
	 */
	void exitAllField(XenCodeParser.AllFieldContext ctx);
	/**
	 * Enter a parse tree produced by {@link XenCodeParser#tmp}.
	 * @param ctx the parse tree
	 */
	void enterTmp(XenCodeParser.TmpContext ctx);
	/**
	 * Exit a parse tree produced by {@link XenCodeParser#tmp}.
	 * @param ctx the parse tree
	 */
	void exitTmp(XenCodeParser.TmpContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link XenCodeParser#val}.
	 * @param ctx the parse tree
	 */
	void enterVal(XenCodeParser.ValContext ctx);
	/**
	 * Exit a parse tree produced by {@link XenCodeParser#val}.
	 * @param ctx the parse tree
	 */
	void exitVal(XenCodeParser.ValContext ctx);
	/**
	 * Enter a parse tree produced by {@link XenCodeParser#var}.
	 * @param ctx the parse tree
	 */
	void enterVar(XenCodeParser.VarContext ctx);
	/**
	 * Exit a parse tree produced by {@link XenCodeParser#var}.
	 * @param ctx the parse tree
	 */
	void exitVar(XenCodeParser.VarContext ctx);
	/**
	 * Enter a parse tree produced by {@link XenCodeParser#imports}.
	 * @param ctx the parse tree
	 */
	void enterImports(XenCodeParser.ImportsContext ctx);
	/**
	 * Exit a parse tree produced by {@link XenCodeParser#imports}.
	 * @param ctx the parse tree
	 */
	void exitImports(XenCodeParser.ImportsContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link XenCodeParser#allMethod}.
	 * @param ctx the parse tree
	 */
	void enterAllMethod(XenCodeParser.AllMethodContext ctx);
	/**
	 * Exit a parse tree produced by {@link XenCodeParser#allMethod}.
	 * @param ctx the parse tree
	 */
	void exitAllMethod(XenCodeParser.AllMethodContext ctx);
	/**
